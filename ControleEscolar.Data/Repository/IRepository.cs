...
namespace ControleEscolar.Data.Repository
{
    public interface IRepository : IDisposable
    {
        ...
        /// <returns></returns>
        T Create<T>(T t, string[] includes = null) where T : class, IEntityBase;
        ...
        /// <returns></returns>
        int Update<T>(T t, string[] includes = null) where T : class, IEntityBase;

        object Save<T>(T entitySent, string[] includes = null) where T : class, IEntityBase;
