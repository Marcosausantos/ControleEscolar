(function () {
    ...
    usuariocontroller.$inject = ['$routeParams', 'utils', 'ngToast', 'dataService', 'factory', 'controller', 'title', 'entidades'];
        
    function usuariocontroller($routeParams, utils, ngToast, dataService, factory, controller, title, entidades) {
